      ...
      case "STATES STARTUP RANKING":
        return (
          <div>
            ...
            The States’ Startup Ranking is an annual capacity building exercise which has been developed with the objective to build a conducive startup ecosystem across the country, through sustained efforts of States and Union Territories.            </p>
          </div>
        );
      ...
      case "SEED FUND SCHEME":
        return (
          <div>
            ...
            <p className="text-gray-600 leading-relaxed pl-6 pr-6">
            The Startup India Seed Fund Scheme (SISFS) aims to provide financial assistance to startups for proof of concept, prototype development, product trials, market entry & commercialization.            </p>
          </div>
        );
      case "MAARG":
        return (
          <div>
            ...
            <p className="text-gray-600 leading-relaxed pl-6 pr-6">
            The MAARG mentorship platform aims at facilitating intelligent matchmaking between mentors & startups across varied sectors at scale.            </p>
          </div>
        );
      case "SCO":
        return (
          <div>
            ...
            <p className="text-gray-600 leading-relaxed pl-6 pr-6">
            The Shanghai Cooperation Organisation (SCO), founded in 2001, includes over 25 nations. To promote innovation, the SCO created a Special Working Group for Startups, chaired permanently by India. India's DPIIT leads this group, organizing annual meetings and the SCO Startup Forum to support the startup ecosystem in member states.
            </p>
          </div>
        );
  ...
  return (
    <div className="max-w-6xl mx-auto my-8 bg-white rounded-lg overflow-hidden">
      ...
      <div className="bg-gray-50 p-6 border-b border-gray-300">
        <h1 className="text-4xl text-center font-bold text-gray-800">Key Initiatives</h1>
      ...
      <div className="flex flex-col md:flex-row">
        {/* Sidebar */}
        <div className="w-full md:w-1/4 bg-gray-50 p-4 border-b md:border-b-0 md:border-r border-gray-300">
